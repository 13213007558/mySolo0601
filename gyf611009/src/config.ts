import type { CompetitionConfig, Wine, Supervisor, Judge } from './types.js';
...
const JUDGES: Omit<Judge, 'currentBlindId' | 'wines'>[] = [
...
export function verifyPin(supervisorId: string, pin: string): boolean {
