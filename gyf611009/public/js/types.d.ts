...
export type AuditAction = 'SPIT_RECORDED' | 'SCORE_SUBMITTED' | 'WINE_LOCKED_AUTO' | 'SUPERVISOR_UNLOCK' | 'SIP_LIMIT_EXCEEDED' | 'SENSOR_MISMATCH' | 'SENSOR_VERIFIED' | 'JUDGE_LOGIN' | 'WINE_ACTIVATED';
...
export type AppView = 'judge' | 'supervisor' | 'bigscreen' | 'report';
...
export declare const SCORE_DIMENSIONS: readonly ["appearance", "aroma", "taste", "finish"];
