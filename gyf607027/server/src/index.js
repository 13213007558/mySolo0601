...
app.get('/api/cases/:id', (req, res) => {
  ...
  const events = db.prepare('SELECT * FROM timeline_events WHERE case_id = ? ORDER BY created_at ASC').get(req.params.id);
  const materials = db.prepare('SELECT * FROM materials WHERE case_id = ? ORDER BY created_at ASC').get(req.params.id);
  const audits = db.prepare('SELECT * FROM audits WHERE case_id = ? ORDER BY created_at ASC').get(req.params.id);
