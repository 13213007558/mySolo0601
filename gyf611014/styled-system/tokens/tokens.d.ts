/* eslint-disable */
export type Token = `aspectRatios.${AspectRatioToken}` | `borders.${BorderToken}` | `easings.${EasingToken}` | `durations.${DurationToken}` | `fontWeights.${FontWeightToken}` | `lineHeights.${LineHeightToken}` | `letterSpacings.${LetterSpacingToken}` | `blurs.${BlurToken}` | `sizes.${SizeToken}` | `animations.${AnimationToken}` | `colors.${ColorToken}` | `fonts.${FontToken}` | `fontSizes.${FontSizeToken}` | `spacing.${SpacingToken}` | `radii.${RadiusToken}` | `shadows.${ShadowToken}` | `breakpoints.${BreakpointToken}`

export type ColorPalette = "current" | "black" | "white" | "transparent" | "rose" | "pink" | "fuchsia" | "purple" | "violet" | "indigo" | "blue" | "sky" | "cyan" | "teal" | "emerald" | "green" | "lime" | "yellow" | "amber" | "orange" | "red" | "neutral" | "stone" | "zinc" | "gray" | "slate" | "primary" | "primary-dark" | "primary-light" | "accent" | "accent-dark" | "danger" | "success" | "warning" | "info" | "surface" | "surface-muted" | "surface-hover" | "border" | "border-strong" | "text" | "bg" | "fg"
...
export type RadiusToken = "xs" | "2xl" | "3xl" | "4xl" | "sm" | "md" | "lg" | "xl" | "full"

export type ShadowToken = "2xs" | "xs" | "2xl" | "inset-2xs" | "inset-xs" | "inset-sm" | "sm" | "md" | "lg" | "xl"
